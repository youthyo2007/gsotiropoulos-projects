package com.socialvideo.visualcaptcha;
...
public class CaptchaServlet extends HttpServlet {
   ...
   private static final Logger log = LoggerFactory.getLogger(CaptchaServlet.class);
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        this.imagesPath="visualcaptcha/images/";
        this.audioPath="visualcaptcha/audios/";
...
*/
    ...
    private void writeImageResponse(CaptchaAnswer answer, boolean retina, HttpServletResponse resp) throws IOException {
    	Resource resource = new ClassPathResource(getImagePath(answer, retina));
    	ByteStreams.copy(resource.getInputStream(), resp.getOutputStream());
    ...
    private void loadImages() {
        ...
        try{
            ...
            reader = new InputStreamReader(Thread.currentThread().getContextClassLoader().getResourceAsStream("com/socialvideo/visualcaptcha/images.json"));
    ...
    private void loadAudios() {
        Reader reader = null;
        try{
            reader = new InputStreamReader(Thread.currentThread().getContextClassLoader().getResourceAsStream("com/socialvideo/visualcaptcha/audios.json"));
