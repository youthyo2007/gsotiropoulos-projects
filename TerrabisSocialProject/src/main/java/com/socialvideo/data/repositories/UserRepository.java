...
public interface UserRepository extends CrudRepository<UserEntity, Long>  {
	...
	/**
	 * Find the user with the given email. This method will be translated into a query using the
	 * {@link javax.persistence.NamedQuery} annotation at the {@link UserEntity} class.
	 * 
	 * @param email
	 * @return
	 */
	 ...
	 * @return
	 */
	@Query("select u from UserEntity u where u.firstname = :name or u.lastname = :name")
	List<UserEntity> findByFirstnameOrLastname(String name);
	 ...
	 * @return
	 */
	Slice<UserEntity> findByLastnameOrderByUsernameAsc(String lastname, Pageable page);
	 ...
	 * @return
	 */
	List<UserEntity> findFirst2ByOrderByLastnameAsc();
	 ...
	 * @return
	 */
	List<UserEntity> findTop2By(Sort sort);
	 ...
	 * @return
	 */
	@Query("select u from UserEntity u where u.firstname = :#{#user.firstname} or u.lastname = :#{#user.lastname}")
	Iterable<UserEntity> findByFirstnameOrLastname(UserEntity user);


	
	/**
	 * Find the user with the given UUID. This method will be translated into a query using the
	 * {@link javax.persistence.NamedQuery} annotation at the {@link UserEntity} class.
	 * 
	 * @param UUID
	 * @return
	...
	@Query("select u from UserEntity u where u.UUID = :UUIDString")
	UserEntity findByUUID(@Param("UUIDString") String UUIDString);
