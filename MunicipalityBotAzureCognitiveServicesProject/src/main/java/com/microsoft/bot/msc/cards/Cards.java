package com.microsoft.bot.msc.cards;
...
public class Cards {
    ...
    public static HeroCard getStartMenuCard() {
        ...
        heroCard.setButtons(new CardAction(ActionTypes.OPEN_URL, "Telephone Directory", "https://docs.microsoft.com/bot-framework"));
        heroCard.setButtons(new CardAction(ActionTypes.OPEN_URL, "Tourist Guide", "https://docs.microsoft.com/bot-framework"));
        return heroCard;
    }
