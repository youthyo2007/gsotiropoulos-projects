...
public class Cards {
    ...
    public static HeroCard getHeroDimarxioCard() {
        HeroCard heroCard = new HeroCard();
        heroCard.setTitle("Δημαρχείο Κορίνθου");
        heroCard.setSubtitle("Κολιάτσου 32, Κόρινθος");
        ...
        heroCard.setButtons(
            new CardAction(ActionTypes.OPEN_URL, "Γραφείο Δημάρχου", "https://docs.microsoft.com/bot-framework"),
                new CardAction(ActionTypes.OPEN_URL, "Δημοτολόγιο", "https://docs.microsoft.com/bot-framework"),
                new CardAction(ActionTypes.OPEN_URL, "Ληξιαρχείο", "https://docs.microsoft.com/bot-framework"),
                new CardAction(ActionTypes.OPEN_URL, "Έσοδα", "https://docs.microsoft.com/bot-framework"),
                new CardAction(ActionTypes.OPEN_URL, "Οικονομικό", "https://docs.microsoft.com/bot-framework"),
                new CardAction(ActionTypes.OPEN_URL, "Προμήθειες", "https://docs.microsoft.com/bot-framework")
                );
