 ...
 * @param <T> is a Dialog.
 */
public class DimosKorinthionBot<T extends Dialog> extends DialogBot {
     ...
     */
    public DimosKorinthionBot(ConversationState withConversationState, UserState withUserState, T withDialog) {
    ...
    protected CompletableFuture<Void> onMembersAdded(List<ChannelAccount> membersAdded, TurnContext turnContext) {
        return turnContext.getActivity().getMembersAdded().stream()
                ...
                }).collect(CompletableFutures.toFutureList()).thenApply(resourceResponse -> null);
    }
